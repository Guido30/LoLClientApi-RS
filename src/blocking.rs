...
use crate::types::{
    lol_champ_select, lol_champions, lol_chat, lol_heartbeat, lol_summoner,
};
...
impl LeagueClient {
    ...
    pub fn get_lol_chat_v1_friends(
        &self,
    ...
    pub fn post_lol_heartbeat_v1_connection_status(
        &self,
